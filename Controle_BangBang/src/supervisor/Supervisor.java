...
import controladores.ControleBangBang;
import objetos.Robo;
...
public class Supervisor {
	...
	public static void main(String[] args) {
		...
		//JFreeChart chart = ChartFactory.createScatterPlot("Gráfico", "eixo x", "eixo y", dataset, PlotOrientation.VERTICAL, true, true, false);
	...
	/**
	 * converte a correção da velocidade do robo na correção da velocidade de cada
	 * motor
	 * @param V velocidade de esperança
	 * @param W correção a ser aplicada no robo
	 * @return array contendo a correção dos motores
	 */
